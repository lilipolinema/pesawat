...
<head>
	<title>Ubah Customer Pesawatcu</title>
	<!-- Meta tag Keywords -->
							...
							<div class="card-body">
								...
								<?php echo form_hidden('id_customer',$datacustomer[0]->id_customer); ?>
									...
									<tbody align="center">
										<tr>
											<th>ID Customer</th>
											<td width="70%"><?php echo form_input('customer',$datacustomer[0]->id_customer,"disabled"); ?></td>
										</tr>
										<tr>
											<th>Nama</th>
											<td width="70%"><?php echo form_input('nama',$datacustomer[0]->nama); ?></td>
										</tr>
										<tr>
											<th>Alamat</th>
											<td width="70%"><?php echo form_input('alamat',$datacustomer[0]->alamat); ?></td>
										</tr>
										<tr>
											<th>No Telepon</th>
											<td width="70%"><?php echo form_input('notelp',$datacustomer[0]->notelp); ?></td>
										</tr>
										<tr>
											<th>Jenis Kelamin</th>
											<td width="70%"><?php echo form_input('gender',$datacustomer[0]->gender); ?></td>
										</tr>
										<tr>
