...
<head>
	<title>Customer Pesawatcu</title>
	<!-- Meta tag Keywords -->
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Data <span>Customer</span><br></h3>
						...
						<div class="container-fluid"><br>
							<div class="card shadow mb-4">
								...
								<a href="<?= base_url();?>customer/create">Tambah Data</a></h6>
								</div>
							<div class="card-body">
								...
								<?php endif; ?>
									...
									<thead align="center">
										<tr>
										<th class="table-primary">ID Customer</th>
									...
									<?php
										...
										echo "<tr>
										<td>$cst->id_customer</td>
										<td>$cst->nama</td>
										<td>$cst->alamat</td>
										<td>$cst->notelp</td>
										<td>$cst->gender</td>
										<td>
										".anchor('customer/edit/'.$cst->id_customer,'Ubah')." | "
										.anchor('customer/delete/'.$cst->id_customer,'Hapus')."</td>
										</tr>";
										endforeach; ?>
									</tbody>
									</table>
