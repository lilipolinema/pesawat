...
<head>
	<title>Ubah Rute Pesawatcu</title>
	<!-- Meta tag Keywords -->
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li><a href="<?php echo base_url() ?>rute/index" class="active">Rute</a></li>
							</ul>
						</nav>
					</div>
					<!-- //nav -->
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Ubah <span>Customer</span><br></h3>
						...
						<div class="container-fluid"><br>
							<div class="card shadow mb-4">
								...
								<a href="<?= base_url();?>rute">Kembali</a></h6>
								</div>
							<div class="card-body">
								<?php echo form_open_multipart('rute/edit'); ?>
								<?php echo form_hidden('id_rute',$datarute[0]->id_rute); ?>
									<table class="table table-bordered table-light" width="100%" cellspacing="0">
									<tbody align="center">
										<tr>
											<th>ID Rute</th>
											<td width="70%"><?php echo form_input('rute',$datarute[0]->id_rute,"disabled"); ?></td>
										</tr>
										<tr>
											<th>Keberangkatan</th>
											<td width="70%"><?php echo form_input('rute_dari',$datarute[0]->rute_dari); ?></td>
										</tr>
										<tr>
											<th>Pendaratan</th>
											<td width="70%"><?php echo form_input('rute_ke',$datarute[0]->rute_ke); ?></td>
										</tr>
										<tr>
											<th>Jam Keberangkatan</th>
											<td width="70%"><?php echo form_input('jam_berangkat',$datarute[0]->jam_berangkat); ?></td>
										</tr>
										<tr>
											<th>Jam Pendaratan</th>
											<td width="70%"><?php echo form_input('jam_tiba',$datarute[0]->jam_tiba); ?></td>
										</tr>
										<tr>
											<th>Harga</th>
											<td width="70%"><?php echo form_input('harga',$datarute[0]->harga); ?></td>
										</tr>
										<tr>
