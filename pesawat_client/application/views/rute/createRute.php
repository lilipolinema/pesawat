...
<head>
	<title>Tambah Rute Pesawatcu</title>
	<!-- Meta tag Keywords -->
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Tambah <span>Rute Penerbangan</span><br></h3>
						...
						<div class="container-fluid"><br>
							...
							<div class="card-body">
								<?php echo form_open_multipart('rute/create'); ?>
									<table class="table table-bordered table-light" width="100%" cellspacing="0">
									<tbody align="center">
										<tr>
											<th>ID Rute</th>
											<td width="70%"><?php echo form_input('id_rute'); ?></td>
										</tr>
										<tr>
											<th>Keberangkatan</th>
											<td width="70%"><?php echo form_input('rute_dari'); ?></td>
										</tr>
										<tr>
											<th>Pendaratan</th>
											<td width="70%"><?php echo form_input('rute_ke'); ?></td>
										</tr>
										<tr>
											<th>Jam Keberangkatan</th>
											<td width="70%"><?php echo form_input('jam_berangkat'); ?></td>
										</tr>
										<tr>
											<th>Jam Pendaratan</th>
											<td width="70%"><?php echo form_input('jam_tiba'); ?></td>
										</tr>
										<tr>
											<th>Harga</th>
											<td width="70%"><?php echo form_input('harga'); ?></td>
										</tr>
										<tr>
