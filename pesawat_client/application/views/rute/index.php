			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Data <span>Rute Penerbangan</span><br></h3>
						...
						<div class="container-fluid"><br>
							<div class="card shadow mb-4">
								...
								<a href="<?= base_url();?>rute/create">Tambah Data</a></h6>
								</div>
							<div class="card-body">
								...
								<?php endif; ?>
									...
									<thead align="center">
										<tr>
										<th class="table-primary">ID Rute</th>
										<th class="table-primary">Pemberangkatan</th>
										<th class="table-primary">Pendaratan</th>
										<th class="table-primary">Jam Keberangkatan</th>
										<th class="table-primary">Jam Pendaratan</th>
									...
									<?php
										...
										<td>$rt->rute_dari</td>
										<td>$rt->rute_ke</td>
										<td>$rt->jam_berangkat</td>
										<td>$rt->jam_tiba</td>
										<td>$rt->harga</td>
										<td>
										".anchor('rute/edit/'.$rt->id_rute,'Ubah')." | "
										.anchor('rute/delete/'.$rt->id_rute,'Hapus')."</td>
										</tr>";
										endforeach; ?>
									</tbody>
									</table>
