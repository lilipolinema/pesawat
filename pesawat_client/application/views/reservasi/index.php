...
<head>
	<title>Reservasi di Pesawatcu</title>
	<!-- Meta tag Keywords -->
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Data <span>Reservasi</span><br></h3>
						...
						<div class="container-fluid"><br>
							<div class="card shadow mb-4">
								...
								<a href="<?= base_url();?>reservasi/create">Tambah Data</a></h6>
								</div>
							<div class="card-body">
								...
								<?php endif; ?>
									...
									<thead align="center">
										<tr>
										<th class="table-primary">ID Reservasi</th>
										<th class="table-primary">Tsnggsl</th>
										<th class="table-primary">Nama Customer</th>
										<th class="table-primary">Nomor Kursi</th>
									...
									<?php
										...
										<td>$rsv->id_rute</td>
										<td>
										".anchor('reservasi/edit/'.$rsv->id_reservasi,'Ubah')."
										</tr>";
										endforeach; ?>
									</tbody>
									</table>
