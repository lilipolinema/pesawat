...
<head>
	<title>Tambah Reservasi Pesawatcu</title>
	<!-- Meta tag Keywords -->
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Tambah <span>Reservasi</span><br></h3>
						...
						<div class="container-fluid"><br>
							...
							<div class="card-body">
								<?php echo form_open_multipart('reservasi/create'); ?>
									<table class="table table-bordered table-light" width="100%" cellspacing="0">
									<tbody align="center">
										<tr>
											<th>ID Reservasi</th>
											<td width="70%"><?php echo form_input('id_reservasi'); ?></td>
										</tr>
										<tr>
											<th>Tanggal</th>
											<td width="70%"><?php echo form_input('tanggal'); ?></td>
										</tr>
										<tr>
											<th>ID Customer</th>
										...
										<tr>
											<th>Nomor Kursi</th>
											<td width="70%"><?php echo form_input('nmr_kursi'); ?></td>
										</tr>
										<tr>
											<th>ID Rute</th>
