...
<head>
	<title>Ubah Reservasi Pesawatcu</title>
	<!-- Meta tag Keywords -->
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li><a href="<?php echo base_url() ?>reservasi/index" class="active">Reservasi</a></li>
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="w3ls_banner_txt">
						<h3 class="w3ls_pvt-title">Ubah <span>Reservasi</span><br></h3>
						...
						<div class="container-fluid"><br>
							<div class="card shadow mb-4">
								...
								<a href="<?= base_url();?>reservasi">Kembali</a></h6>
								</div>
							<div class="card-body">
								<?php echo form_open_multipart('reservasi/edit'); ?>
								<?php echo form_hidden('id_reservasi',$datareservasi[0]->id_reservasi); ?>
									<table class="table table-bordered table-light" width="100%" cellspacing="0">
									<tbody align="center">
										<tr>
											<th>ID reservasi</th>
											<td width="70%"><?php echo form_input('reservasi',$datareservasi[0]->id_reservasi,"disabled"); ?></td>
										</tr>
										<tr>
											<th>Tanggal</th>
											<td width="70%"><?php echo form_input('nama',$datareservasi[0]->tanggal); ?></td>
										</tr>
										<tr>
											<th>ID Customer</th>
											<td width="70%"><?php echo form_input('alamat',$datareservasi[0]->id_customer); ?></td>
										</tr>
										<tr>
											<th>Nomor Kursi</th>
											<td width="70%"><?php echo form_input('notelp',$datareservasi[0]->nmr_kursi); ?></td>
										</tr>
										<tr>
											<th>ID Rute</th>
											<td width="70%"><?php echo form_input('gender',$datareservasi[0]->id_rute); ?></td>
										</tr>
										<tr>
